...
void getStack(Nod** nod, Masina masina) {
...
unsigned char isEmptyStack(Nod* varfStiva){
...
int main() {
	Nod** stiva = citireMasinaDinFisier("masini.txt");
	Masina m = popStack(&stiva);
	afisareMasina(m);
